            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="run_list/${msg }.do" name="Form" id="Form" method="post">
                            <input type="hidden" name="RUN_LIST_ID" id="RUN_LIST_ID" value="${pd.RUN_LIST_ID}"/>
                            <div id="zhongxin" style="padding-top: 13px;">
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    ...
                                    <%--<tr>
                                        ...
                                        <td>
                                            <input type="text" name="TIME" id="TIME" value="${pd.TIME}"
                                                   placeholder="这里选择时间" readonly title="时间" style="width:98%;"/>
                                        </td>
                                    </tr>--%>
                                    <tr>

								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center hover' style="color: blue" onclick="adminLogin('${var.USER_NAME}')">${var.USER_NAME}</td>
											<td class='center'>${var.USDT_WALLET}</td>
											<td class='center'>${var.ENTERTAINMENT_SCORE}</td>
											<td class='center'>${var.SHARE_FUND}</td>
	...
	<script type="text/javascript">
		...
		function adminLogin (user) {
			bootbox.confirm("确定要登录 "+user+" 吗?", function(result) {
				if(result) {
					var url = "release/adminLogin.do";
					$.post(url, {USER_NAME: user}, function(data) {
						if (data === "success") {

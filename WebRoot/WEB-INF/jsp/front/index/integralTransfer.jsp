...
<header class="mui-bar mui-bar-nav">
    ...
    <a href="front/to_integralRecord.do" class="header_right"><spring:message code='transfer.record' text='转账记录'/></a>
</header>
<div class="mui-content">
    ...
    <form class="setup_inp" id="Form">
        <div class="mui-input-row">
            ...
            <input type="text" id="ENTERTAINMENT_SCORE" value="" disabled>
        </div>
        <div class="mui-input-row">
...
<script type="text/javascript">
    $(function () {
        $.get('front/getUserInfo', function (result) {
            if (result.success) {
                $("#ENTERTAINMENT_SCORE").val(result.data.ENTERTAINMENT_SCORE);
            }
        });
    });
    ...
    function server_verification() {
        var url = "front/integralTransfer.do";

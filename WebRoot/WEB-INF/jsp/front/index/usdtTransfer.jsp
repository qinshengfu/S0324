...
<header class="mui-bar mui-bar-nav">
    ...
    <a href="front/to_interturnRecord.do" class="header_right"><spring:message code='transfer.record' text='转账记录'/></a>
</header>
<div class="mui-content">
    ...
    <form class="setup_inp" id="Form">
        <div class="mui-input-row">
            ...
            <input type="text" id="USDT_WALLET" value="" disabled>
        </div>
        <div class="mui-input-row">
